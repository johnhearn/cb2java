...
public class Parser {
	...
	/*
	 * { {{-1, ERROR, 0}, {9, SHIFT, 1}, {10, SHIFT, 2}, }, {{-1, ERROR, 1},
	 * {74, SHIFT, 9}, }, {{-1, REDUCE, 6}, {17, SHIFT, 10}, {18, SHIFT, 11},
	 * {21, SHIFT, 12}, {22, SHIFT, 13}, {23, SHIFT, 14}, {24, SHIFT, 15}, {25,
	 * SHIFT, 16}, {26, SHIFT, 17}, {27, SHIFT, 18}, {30, SHIFT, 19}, {31,
	 * SHIFT, 20}, {32, SHIFT, 21}, {33, SHIFT, 22}, {35, SHIFT, 23}, {36,
	 * SHIFT, 24}, {38, SHIFT, 25}, {41, SHIFT, 26}, {43, SHIFT, 27}, {46,
	 * SHIFT, 28}, {49, SHIFT, 29}, {50, SHIFT, 30}, {52, SHIFT, 31}, {53,
	 * SHIFT, 32}, {54, SHIFT, 33}, {55, SHIFT, 34}, {57, SHIFT, 35}, {62,
	 * SHIFT, 36}, {64, SHIFT, 37}, {68, SHIFT, 38}, {69, SHIFT, 39}, {70,
	 * SHIFT, 40}, {74, SHIFT, 41}, }, {{-1, ERROR, 3}, {75, ACCEPT, -1}, },
	 * {{-1, ERROR, 4}, {0, SHIFT, 63}, }, {{-1, REDUCE, 1}, }, {{-1, REDUCE,
	 * 3}, }, {{-1, REDUCE, 4}, }, {{-1, REDUCE, 5}, }, {{-1, ERROR, 9}, {70,
	 * SHIFT, 64}, {71, SHIFT, 65}, }, {{-1, REDUCE, 87}, {47, SHIFT, 67}, },
	 * {{-1, ERROR, 11}, {72, SHIFT, 68}, {73, SHIFT, 69}, }, {{-1, REDUCE, 89},
	 * }, {{-1, REDUCE, 90}, {47, SHIFT, 70}, }, {{-1, REDUCE, 92}, {47, SHIFT,
	 * 71}, }, {{-1, REDUCE, 94}, }, {{-1, REDUCE, 95}, {47, SHIFT, 72}, },
	 * {{-1, REDUCE, 97}, }, {{-1, ERROR, 18}, {34, SHIFT, 73}, }, {{-1, REDUCE,
	 * 98}, {47, SHIFT, 74}, }, {{-1, REDUCE, 100}, {47, SHIFT, 75}, }, {{-1,
	 * REDUCE, 34}, }, {{-1, REDUCE, 15}, }, {{-1, REDUCE, 108}, }, {{-1,
	 * REDUCE, 35}, }, {{-1, REDUCE, 102}, }, {{-1, REDUCE, 36}, {60, SHIFT,
	 * 76}, }, {{-1, REDUCE, 75}, }, {{-1, REDUCE, 103}, }, {{-1, ERROR, 29},
	 * {58, SHIFT, 77}, }, {{-1, ERROR, 30}, {9, SHIFT, 78}, {10, SHIFT, 79}, },
	 * {{-1, REDUCE, 105}, }, {{-1, ERROR, 32}, {1, SHIFT, 82}, {2, SHIFT, 83},
	 * {3, SHIFT, 84}, {4, SHIFT, 85}, {5, SHIFT, 86}, {6, SHIFT, 87}, {7,
	 * SHIFT, 88}, {10, SHIFT, 89}, {12, SHIFT, 90}, {13, SHIFT, 91}, {40,
	 * SHIFT, 92}, {74, SHIFT, 93}, }, {{-1, REDUCE, 106}, }, {{-1, REDUCE,
	 * 107}, }, {{-1, ERROR, 35}, {74, SHIFT, 97}, }, {{-1, REDUCE, 73}, {40,
	 * SHIFT, 98}, }, {{-1, REDUCE, 79}, {44, SHIFT, 99}, {60, SHIFT, 100}, },
	 * {{-1, REDUCE, 76}, }, {{-1, REDUCE, 85}, {40, SHIFT, 102}, }, {{-1,
	 * ERROR, 40}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103}, {12,
	 * SHIFT, 104}, {14, SHIFT, 105}, {37, SHIFT, 106}, {40, SHIFT, 107}, {45,
	 * SHIFT, 108}, {48, SHIFT, 109}, {56, SHIFT, 110}, {63, SHIFT, 111}, {73,
	 * SHIFT, 112}, }, {{-1, REDUCE, 14}, {59, SHIFT, 115}, }, {{-1, REDUCE, 7},
	 * {17, SHIFT, 10}, {18, SHIFT, 11}, {21, SHIFT, 12}, {22, SHIFT, 13}, {23,
	 * SHIFT, 14}, {24, SHIFT, 15}, {25, SHIFT, 16}, {26, SHIFT, 17}, {27,
	 * SHIFT, 18}, {30, SHIFT, 19}, {31, SHIFT, 20}, {32, SHIFT, 21}, {35,
	 * SHIFT, 23}, {36, SHIFT, 24}, {38, SHIFT, 25}, {41, SHIFT, 26}, {43,
	 * SHIFT, 27}, {46, SHIFT, 28}, {49, SHIFT, 29}, {50, SHIFT, 30}, {52,
	 * SHIFT, 31}, {53, SHIFT, 32}, {54, SHIFT, 33}, {55, SHIFT, 34}, {57,
	 * SHIFT, 35}, {62, SHIFT, 36}, {64, SHIFT, 37}, {68, SHIFT, 38}, {69,
	 * SHIFT, 39}, {70, SHIFT, 40}, }, {{-1, REDUCE, 8}, {17, SHIFT, 10}, {18,
	 * SHIFT, 11}, {21, SHIFT, 12}, {22, SHIFT, 13}, {23, SHIFT, 14}, {24,
	 * SHIFT, 15}, {25, SHIFT, 16}, {26, SHIFT, 17}, {27, SHIFT, 18}, {30,
	 * SHIFT, 19}, {31, SHIFT, 20}, {32, SHIFT, 21}, {35, SHIFT, 23}, {36,
	 * SHIFT, 24}, {38, SHIFT, 25}, {41, SHIFT, 26}, {43, SHIFT, 27}, {46,
	 * SHIFT, 28}, {49, SHIFT, 29}, {50, SHIFT, 30}, {52, SHIFT, 31}, {53,
	 * SHIFT, 32}, {54, SHIFT, 33}, {55, SHIFT, 34}, {62, SHIFT, 36}, {64,
	 * SHIFT, 37}, {68, SHIFT, 38}, {69, SHIFT, 39}, {70, SHIFT, 40}, }, {{-1,
	 * REDUCE, 10}, {17, SHIFT, 10}, {18, SHIFT, 11}, {21, SHIFT, 12}, {22,
	 * SHIFT, 13}, {23, SHIFT, 14}, {24, SHIFT, 15}, {25, SHIFT, 16}, {26,
	 * SHIFT, 17}, {27, SHIFT, 18}, {30, SHIFT, 19}, {31, SHIFT, 20}, {32,
	 * SHIFT, 21}, {35, SHIFT, 23}, {36, SHIFT, 24}, {38, SHIFT, 25}, {41,
	 * SHIFT, 26}, {43, SHIFT, 27}, {46, SHIFT, 28}, {49, SHIFT, 29}, {50,
	 * SHIFT, 30}, {52, SHIFT, 31}, {53, SHIFT, 32}, {54, SHIFT, 33}, {55,
	 * SHIFT, 34}, {62, SHIFT, 36}, {64, SHIFT, 37}, {68, SHIFT, 38}, {69,
	 * SHIFT, 39}, {70, SHIFT, 40}, }, {{-1, REDUCE, 17}, }, {{-1, REDUCE, 19},
	 * }, {{-1, REDUCE, 20}, }, {{-1, REDUCE, 21}, }, {{-1, REDUCE, 22}, },
	 * {{-1, REDUCE, 23}, }, {{-1, REDUCE, 24}, }, {{-1, REDUCE, 38}, {16,
	 * SHIFT, 120}, {29, SHIFT, 121}, {39, SHIFT, 122}, }, {{-1, REDUCE, 25}, },
	 * {{-1, REDUCE, 26}, }, {{-1, ERROR, 55}, {43, SHIFT, 27}, {68, SHIFT, 38},
	 * }, {{-1, REDUCE, 69}, {61, SHIFT, 129}, }, {{-1, REDUCE, 27}, }, {{-1,
	 * REDUCE, 28}, }, {{-1, ERROR, 59}, {17, SHIFT, 10}, {21, SHIFT, 12}, {22,
	 * SHIFT, 13}, {23, SHIFT, 14}, {24, SHIFT, 15}, {25, SHIFT, 16}, {26,
	 * SHIFT, 17}, {30, SHIFT, 19}, {31, SHIFT, 20}, {35, SHIFT, 23}, {38,
	 * SHIFT, 25}, {46, SHIFT, 28}, {49, SHIFT, 29}, {52, SHIFT, 31}, {54,
	 * SHIFT, 33}, {55, SHIFT, 34}, }, {{-1, REDUCE, 83}, }, {{-1, REDUCE, 104},
	 * }, {{-1, REDUCE, 29}, }, {{-1, REDUCE, 0}, {9, SHIFT, 1}, {10, SHIFT, 2},
	 * }, {{-1, REDUCE, 119}, {40, SHIFT, 133}, }, {{-1, REDUCE, 121}, {15,
	 * SHIFT, 134}, }, {{-1, ERROR, 66}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11,
	 * SHIFT, 103}, {12, SHIFT, 104}, {14, SHIFT, 135}, {37, SHIFT, 106}, {45,
	 * SHIFT, 108}, {48, SHIFT, 109}, {56, SHIFT, 110}, {63, SHIFT, 111}, {73,
	 * SHIFT, 112}, }, {{-1, REDUCE, 88}, }, {{-1, ERROR, 68}, {73, SHIFT, 138},
	 * }, {{-1, REDUCE, 30}, }, {{-1, REDUCE, 91}, }, {{-1, REDUCE, 93}, },
	 * {{-1, REDUCE, 96}, }, {{-1, ERROR, 73}, {40, SHIFT, 139}, {74, SHIFT,
	 * 140}, }, {{-1, REDUCE, 99}, }, {{-1, REDUCE, 101}, }, {{-1, REDUCE, 37},
	 * }, {{-1, REDUCE, 109}, {74, SHIFT, 141}, }, {{-1, REDUCE, 154}, }, {{-1,
	 * REDUCE, 153}, }, {{-1, ERROR, 80}, {9, SHIFT, 78}, {10, SHIFT, 79}, },
	 * {{-1, REDUCE, 46}, {28, SHIFT, 143}, {66, SHIFT, 144}, {67, SHIFT, 145},
	 * }, {{-1, REDUCE, 147}, }, {{-1, REDUCE, 145}, }, {{-1, REDUCE, 142}, },
	 * {{-1, REDUCE, 143}, }, {{-1, REDUCE, 144}, }, {{-1, REDUCE, 146}, },
	 * {{-1, ERROR, 88}, {9, SHIFT, 78}, {10, SHIFT, 79}, }, {{-1, REDUCE, 148},
	 * }, {{-1, REDUCE, 149}, }, {{-1, REDUCE, 151}, }, {{-1, ERROR, 92}, {1,
	 * SHIFT, 82}, {2, SHIFT, 83}, {3, SHIFT, 84}, {4, SHIFT, 85}, {5, SHIFT,
	 * 86}, {6, SHIFT, 87}, {7, SHIFT, 88}, {10, SHIFT, 89}, {12, SHIFT, 90},
	 * {13, SHIFT, 91}, {74, SHIFT, 93}, }, {{-1, REDUCE, 141}, }, {{-1, REDUCE,
	 * 67}, {1, SHIFT, 82}, {2, SHIFT, 83}, {3, SHIFT, 84}, {4, SHIFT, 85}, {5,
	 * SHIFT, 86}, {6, SHIFT, 87}, {7, SHIFT, 88}, {10, SHIFT, 89}, {12, SHIFT,
	 * 90}, {13, SHIFT, 91}, {74, SHIFT, 93}, }, {{-1, REDUCE, 139}, }, {{-1,
	 * REDUCE, 150}, }, {{-1, REDUCE, 16}, }, {{-1, REDUCE, 74}, }, {{-1,
	 * REDUCE, 81}, }, {{-1, REDUCE, 82}, }, {{-1, REDUCE, 80}, }, {{-1, REDUCE,
	 * 86}, }, {{-1, REDUCE, 138}, }, {{-1, REDUCE, 137}, }, {{-1, ERROR, 105},
	 * {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103}, {12, SHIFT, 104}, {37,
	 * SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT, 109}, {56, SHIFT, 110}, {63,
	 * SHIFT, 111}, {73, SHIFT, 112}, }, {{-1, REDUCE, 132}, }, {{-1, ERROR,
	 * 107}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103}, {12, SHIFT,
	 * 104}, {14, SHIFT, 150}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT,
	 * 109}, {56, SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, }, {{-1,
	 * REDUCE, 133}, }, {{-1, REDUCE, 135}, }, {{-1, REDUCE, 134}, }, {{-1,
	 * REDUCE, 131}, }, {{-1, REDUCE, 130}, }, {{-1, REDUCE, 114}, }, {{-1,
	 * REDUCE, 136}, }, {{-1, ERROR, 115}, {74, SHIFT, 152}, }, {{-1, REDUCE,
	 * 9}, {17, SHIFT, 10}, {18, SHIFT, 11}, {21, SHIFT, 12}, {22, SHIFT, 13},
	 * {23, SHIFT, 14}, {24, SHIFT, 15}, {25, SHIFT, 16}, {26, SHIFT, 17}, {27,
	 * SHIFT, 18}, {30, SHIFT, 19}, {31, SHIFT, 20}, {32, SHIFT, 21}, {35,
	 * SHIFT, 23}, {36, SHIFT, 24}, {38, SHIFT, 25}, {41, SHIFT, 26}, {43,
	 * SHIFT, 27}, {46, SHIFT, 28}, {49, SHIFT, 29}, {50, SHIFT, 30}, {52,
	 * SHIFT, 31}, {53, SHIFT, 32}, {54, SHIFT, 33}, {55, SHIFT, 34}, {62,
	 * SHIFT, 36}, {64, SHIFT, 37}, {68, SHIFT, 38}, {69, SHIFT, 39}, {70,
	 * SHIFT, 40}, }, {{-1, REDUCE, 11}, {17, SHIFT, 10}, {18, SHIFT, 11}, {21,
	 * SHIFT, 12}, {22, SHIFT, 13}, {23, SHIFT, 14}, {24, SHIFT, 15}, {25,
	 * SHIFT, 16}, {26, SHIFT, 17}, {27, SHIFT, 18}, {30, SHIFT, 19}, {31,
	 * SHIFT, 20}, {32, SHIFT, 21}, {35, SHIFT, 23}, {36, SHIFT, 24}, {38,
	 * SHIFT, 25}, {41, SHIFT, 26}, {43, SHIFT, 27}, {46, SHIFT, 28}, {49,
	 * SHIFT, 29}, {50, SHIFT, 30}, {52, SHIFT, 31}, {53, SHIFT, 32}, {54,
	 * SHIFT, 33}, {55, SHIFT, 34}, {62, SHIFT, 36}, {64, SHIFT, 37}, {68,
	 * SHIFT, 38}, {69, SHIFT, 39}, {70, SHIFT, 40}, }, {{-1, REDUCE, 12}, {17,
	 * SHIFT, 10}, {18, SHIFT, 11}, {21, SHIFT, 12}, {22, SHIFT, 13}, {23,
	 * SHIFT, 14}, {24, SHIFT, 15}, {25, SHIFT, 16}, {26, SHIFT, 17}, {27,
	 * SHIFT, 18}, {30, SHIFT, 19}, {31, SHIFT, 20}, {32, SHIFT, 21}, {35,
	 * SHIFT, 23}, {36, SHIFT, 24}, {38, SHIFT, 25}, {41, SHIFT, 26}, {43,
	 * SHIFT, 27}, {46, SHIFT, 28}, {49, SHIFT, 29}, {50, SHIFT, 30}, {52,
	 * SHIFT, 31}, {53, SHIFT, 32}, {54, SHIFT, 33}, {55, SHIFT, 34}, {62,
	 * SHIFT, 36}, {64, SHIFT, 37}, {68, SHIFT, 38}, {69, SHIFT, 39}, {70,
	 * SHIFT, 40}, }, {{-1, REDUCE, 18}, }, {{-1, REDUCE, 63}, }, {{-1, REDUCE,
	 * 64}, }, {{-1, ERROR, 122}, {19, SHIFT, 154}, {74, SHIFT, 155}, }, {{-1,
	 * REDUCE, 41}, }, {{-1, ERROR, 124}, {40, SHIFT, 157}, {42, SHIFT, 158},
	 * {74, SHIFT, 155}, }, {{-1, REDUCE, 44}, }, {{-1, REDUCE, 39}, {16, SHIFT,
	 * 120}, {29, SHIFT, 121}, {39, SHIFT, 122}, }, {{-1, REDUCE, 42}, {39,
	 * SHIFT, 122}, }, {{-1, REDUCE, 70}, {61, SHIFT, 129}, }, {{-1, REDUCE,
	 * 77}, {20, SHIFT, 164}, }, {{-1, REDUCE, 71}, }, {{-1, REDUCE, 84}, },
	 * {{-1, REDUCE, 2}, }, {{-1, REDUCE, 120}, }, {{-1, REDUCE, 122}, }, {{-1,
	 * ERROR, 135}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103}, {12,
	 * SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT, 109}, {56,
	 * SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, }, {{-1, REDUCE, 118},
	 * {1, SHIFT, 166}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103}, {12,
	 * SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT, 109}, {56,
	 * SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, }, {{-1, REDUCE, 123},
	 * {65, SHIFT, 168}, }, {{-1, REDUCE, 31}, }, {{-1, ERROR, 139}, {74, SHIFT,
	 * 169}, }, {{-1, REDUCE, 32}, }, {{-1, REDUCE, 110}, }, {{-1, ERROR, 142},
	 * {28, SHIFT, 170}, {66, SHIFT, 171}, }, {{-1, ERROR, 143}, {51, SHIFT,
	 * 172}, {74, SHIFT, 173}, }, {{-1, REDUCE, 47}, {28, SHIFT, 174}, }, {{-1,
	 * REDUCE, 56}, }, {{-1, ERROR, 146}, {8, SHIFT, 175}, }, {{-1, REDUCE, 68},
	 * {1, SHIFT, 82}, {2, SHIFT, 83}, {3, SHIFT, 84}, {4, SHIFT, 85}, {5,
	 * SHIFT, 86}, {6, SHIFT, 87}, {7, SHIFT, 88}, {10, SHIFT, 89}, {12, SHIFT,
	 * 90}, {13, SHIFT, 91}, {74, SHIFT, 93}, }, {{-1, REDUCE, 140}, }, {{-1,
	 * REDUCE, 116}, }, {{-1, ERROR, 150}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11,
	 * SHIFT, 103}, {12, SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48,
	 * SHIFT, 109}, {56, SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, },
	 * {{-1, REDUCE, 115}, }, {{-1, REDUCE, 111}, {65, SHIFT, 177}, }, {{-1,
	 * REDUCE, 13}, {17, SHIFT, 10}, {18, SHIFT, 11}, {21, SHIFT, 12}, {22,
	 * SHIFT, 13}, {23, SHIFT, 14}, {24, SHIFT, 15}, {25, SHIFT, 16}, {26,
	 * SHIFT, 17}, {27, SHIFT, 18}, {30, SHIFT, 19}, {31, SHIFT, 20}, {32,
	 * SHIFT, 21}, {35, SHIFT, 23}, {36, SHIFT, 24}, {38, SHIFT, 25}, {41,
	 * SHIFT, 26}, {43, SHIFT, 27}, {46, SHIFT, 28}, {49, SHIFT, 29}, {50,
	 * SHIFT, 30}, {52, SHIFT, 31}, {53, SHIFT, 32}, {54, SHIFT, 33}, {55,
	 * SHIFT, 34}, {62, SHIFT, 36}, {64, SHIFT, 37}, {68, SHIFT, 38}, {69,
	 * SHIFT, 39}, {70, SHIFT, 40}, }, {{-1, ERROR, 154}, {74, SHIFT, 155}, },
	 * {{-1, REDUCE, 59}, }, {{-1, REDUCE, 65}, {74, SHIFT, 180}, }, {{-1,
	 * ERROR, 157}, {74, SHIFT, 155}, }, {{-1, ERROR, 158}, {40, SHIFT, 182},
	 * {74, SHIFT, 155}, }, {{-1, REDUCE, 57}, {74, SHIFT, 180}, }, {{-1,
	 * REDUCE, 40}, }, {{-1, REDUCE, 45}, {39, SHIFT, 122}, }, {{-1, REDUCE,
	 * 43}, }, {{-1, REDUCE, 72}, }, {{-1, REDUCE, 78}, }, {{-1, REDUCE, 124},
	 * }, {{-1, ERROR, 166}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103},
	 * {12, SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT, 109},
	 * {56, SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, }, {{-1, REDUCE,
	 * 125}, {65, SHIFT, 185}, }, {{-1, ERROR, 168}, {9, SHIFT, 78}, {10, SHIFT,
	 * 79}, {11, SHIFT, 103}, {12, SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT,
	 * 108}, {48, SHIFT, 109}, {56, SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT,
	 * 112}, }, {{-1, REDUCE, 33}, }, {{-1, ERROR, 170}, {51, SHIFT, 187}, {74,
	 * SHIFT, 188}, }, {{-1, ERROR, 171}, {28, SHIFT, 189}, }, {{-1, ERROR,
	 * 172}, {74, SHIFT, 190}, }, {{-1, REDUCE, 48}, }, {{-1, ERROR, 174}, {51,
	 * SHIFT, 191}, {74, SHIFT, 192}, }, {{-1, REDUCE, 152}, }, {{-1, REDUCE,
	 * 117}, }, {{-1, ERROR, 177}, {74, SHIFT, 193}, }, {{-1, REDUCE, 112}, },
	 * {{-1, REDUCE, 66}, {74, SHIFT, 180}, }, {{-1, REDUCE, 58}, }, {{-1,
	 * REDUCE, 61}, {74, SHIFT, 180}, }, {{-1, ERROR, 182}, {74, SHIFT, 155}, },
	 * {{-1, REDUCE, 60}, {74, SHIFT, 180}, }, {{-1, REDUCE, 126}, {65, SHIFT,
	 * 195}, }, {{-1, ERROR, 185}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT,
	 * 103}, {12, SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT,
	 * 109}, {56, SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, }, {{-1,
	 * REDUCE, 127}, }, {{-1, ERROR, 187}, {74, SHIFT, 197}, }, {{-1, REDUCE,
	 * 49}, }, {{-1, ERROR, 189}, {51, SHIFT, 198}, {74, SHIFT, 199}, }, {{-1,
	 * REDUCE, 52}, }, {{-1, ERROR, 191}, {74, SHIFT, 200}, }, {{-1, REDUCE,
	 * 50}, }, {{-1, REDUCE, 113}, }, {{-1, REDUCE, 62}, {74, SHIFT, 180}, },
	 * {{-1, ERROR, 195}, {9, SHIFT, 78}, {10, SHIFT, 79}, {11, SHIFT, 103},
	 * {12, SHIFT, 104}, {37, SHIFT, 106}, {45, SHIFT, 108}, {48, SHIFT, 109},
	 * {56, SHIFT, 110}, {63, SHIFT, 111}, {73, SHIFT, 112}, }, {{-1, REDUCE,
	 * 128}, }, {{-1, REDUCE, 53}, }, {{-1, ERROR, 198}, {74, SHIFT, 202}, },
	 * {{-1, REDUCE, 51}, }, {{-1, REDUCE, 54}, }, {{-1, REDUCE, 129}, }, {{-1,
	 * REDUCE, 55}, }, };
	 */
	private static int[][][] gotoTable;
	/*
	 * { {{-1, 3}, }, {{-1, 4}, }, {{-1, 5}, {63, 132}, }, {{-1, 6}, }, {{-1,
	 * 42}, }, {{-1, 43}, {42, 116}, }, {{-1, 44}, {42, 117}, {43, 118}, {116,
	 * 153}, }, {{-1, 45}, {44, 119}, {117, 119}, {118, 119}, {153, 119}, },
	 * {{-1, 46}, }, {{-1, 47}, }, {{-1, 48}, }, {{-1, 49}, }, {{-1, 50}, },
	 * {{-1, 51}, }, {{-1, 52}, }, {{-1, 80}, }, {{-1, 123}, {126, 160}, },
	 * {{-1, 124}, }, {{-1, 125}, {127, 162}, {161, 162}, }, {{-1, 53}, }, {{-1,
	 * 54}, }, {{-1, 55}, }, {{-1, 56}, {55, 128}, }, {{-1, 130}, {128, 163}, },
	 * {{-1, 57}, }, {{-1, 101}, }, {{-1, 58}, }, {{-1, 59}, }, {{-1, 60}, {59,
	 * 131}, }, {{-1, 61}, }, {{-1, 7}, }, {{-1, 178}, }, {{-1, 62}, }, {{-1,
	 * 8}, }, {{-1, 66}, }, {{-1, 136}, }, {{-1, 113}, {66, 137}, {105, 149},
	 * {107, 151}, {135, 165}, {136, 167}, {150, 176}, {166, 184}, {168, 186},
	 * {185, 196}, {195, 201}, }, {{-1, 94}, {92, 147}, }, {{-1, 95}, {94, 148},
	 * {147, 148}, }, {{-1, 96}, }, {{-1, 114}, {30, 81}, {80, 142}, {88, 146},
	 * }, {{-1, 126}, }, {{-1, 127}, {126, 161}, }, {{-1, 156}, {124, 159},
	 * {154, 179}, {157, 181}, {158, 183}, {182, 194}, }, };
	 */
	private static String[] errorMessages;
	/*
	 * { "expecting: number88, number not88", "expecting: data name",
	 ...
	 * , "expecting: EOF", "expecting: '.'", "expecting: value, values",
	 ...
	 * , "expecting: zeros", "expecting: is, data name",
	 ...
	 * , "expecting: is, key, data name", "expecting: by, data name",
	 ...
	 * , "expecting: depending, times", "expecting: on, data name",
	...
	/*
	 * { 0, 1, 2, 3, 4, 4, 4, 4, 4, 5, 6, 7, 8, 6, 6, 8, 6, 8, 9, 6, 6, 8, 10,
	 * 8, 8, 8, 11, 12, 8, 13, 0, 8, 14, 8, 8, 1, 15, 16, 12, 17, 18, 19, 10, 8,
	 * 8, 8, 8, 8, 8, 8, 8, 8, 20, 8, 8, 21, 12, 8, 8, 22, 8, 8, 8, 23, 18, 24,
	 * 25, 8, 26, 8, 8, 8, 8, 27, 8, 8, 8, 28, 29, 29, 0, 30, 31, 31, 31, 31,
	 * 31, 31, 0, 31, 31, 31, 32, 31, 31, 31, 31, 8, 21, 8, 8, 8, 22, 33, 33,
	 * 34, 33, 25, 33, 33, 33, 33, 33, 8, 33, 1, 8, 8, 8, 8, 35, 35, 36, 20, 35,
	 * 37, 20, 37, 12, 38, 8, 8, 4, 25, 25, 34, 39, 40, 8, 1, 8, 8, 41, 42, 43,
	 * 0, 44, 31, 31, 8, 34, 8, 45, 8, 1, 46, 47, 1, 27, 46, 20, 37, 37, 8, 8,
	 * 39, 34, 40, 34, 8, 42, 48, 1, 20, 42, 31, 8, 1, 4, 47, 46, 46, 1, 46, 40,
	 * 34, 39, 1, 20, 42, 20, 1, 20, 4, 46, 34, 39, 20, 1, 20, 20, 39, 20, };
	 */
	...
	static {
		...
		try {
			DataInputStream s = new DataInputStream(new BufferedInputStream(
					Parser.class.getClassLoader().getResourceAsStream(
							"net/sf/cb2xml/sablecc/parser/parser.dat")));
	...
	Node new30() {
		...
		ABlankWhenZeroClause node = new ABlankWhenZeroClause(node1, node2,
				node3);
		return node;
	}
	...
	Node new32() {
		...
		ADateFormatClause node = new ADateFormatClause(node1, node2, node3,
				node4);
		return node;
	}
	...
	Node new40() {
		...
		X1PAscendingOrDescendingKeyPhrase node = new X1PAscendingOrDescendingKeyPhrase(
				node1, node2);
		return node;
	}
	...
	Node new41() {
		...
		X2PAscendingOrDescendingKeyPhrase node = new X2PAscendingOrDescendingKeyPhrase(
				node1);
		return node;
	}
	...
	Node new46() {
		...
		AFixedOccursFixedOrVariable node = new AFixedOccursFixedOrVariable(
				node1, node2, node3);
		return node;
	}
	...
	Node new48() {
		...
		TOccurs node1 = (TOccurs) pop();
		AVariableOccursFixedOrVariable node = new AVariableOccursFixedOrVariable(
	...
	Node new57() {
		...
		AAscendingOrDescendingKeyPhrase node = new AAscendingOrDescendingKeyPhrase(
	...
	Node new63() {
		...
		AAscendingAscendingOrDescending node = new AAscendingAscendingOrDescending(
				node1);
		return node;
	}
	...
	Node new104() {
		...
		AObjectReferencePhraseUsagePhrase node = new AObjectReferencePhraseUsagePhrase(
				node1);
		return node;
	}
	...
	Node new107() {
		...
		AProcedurePointerUsagePhrase node = new AProcedurePointerUsagePhrase(
				node1);
		return node;
	}
	...
	Node new108() {
		...
		AFunctionPointerUsagePhrase node = new AFunctionPointerUsagePhrase(
				node1);
		return node;
	}
	...
	Node new109() {
		...
		AObjectReferencePhrase node = new AObjectReferencePhrase(node1, node2,
				node3);
		return node;
	}
	...
	Node new125() {
		...
		ASequenceLiteralSequence node = new ASequenceLiteralSequence(node1,
				node2, node3);
		return node;
	}
	...
	Node new127() {
		...
		AThroughSingleLiteralSequence node = new AThroughSingleLiteralSequence(
				node1, node2, node3);
		return node;
	}
	...
	Node new128() {
		...
		TComma node2 = null;
		PLiteralSequence node1 = (PLiteralSequence) pop();
		AThroughSequenceLiteralSequence node = new AThroughSequenceLiteralSequence(
	...
	Node new138() {
		...
		AAlphanumericLiteralLiteral node = new AAlphanumericLiteralLiteral(
				node1);
		return node;
	}
	...
	Node new140() {
		...
		ASequenceCharacterString node = new ASequenceCharacterString(node1,
				node2);
		return node;
	}
	...
	Node new141() {
		TDataName node1 = (TDataName) pop();
		ADataNameCharacterSubstring node = new ADataNameCharacterSubstring(
				node1);
		return node;
	}
	...
	Node new149() {
		TNumericLiteral node1 = (TNumericLiteral) pop();
		ANumericLiteralCharacterSubstring node = new ANumericLiteralCharacterSubstring(
				node1);
		return node;
	}
	...
	Node new150() {
		...
		ABracketedNumberCharacterSubstring node = new ABracketedNumberCharacterSubstring(
				node1);
		return node;
	}
